...
Write-Host $about
Write-Host "`n"
Write-Host $PowerDecodeLicense -ForegroundColor yellow
Write-Host "`nCapstone:"
Write-Host $CapstoneLicense -ForegroundColor cyan
Write-Host "`nLiteDB:"
Write-Host $LiteDBLicense -ForegroundColor magenta
Write-Host "`n"
